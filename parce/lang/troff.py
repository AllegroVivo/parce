...
class Troff(Language):
    ...
    @lexicon(re_flags=re.MULTILINE)
    def request(cls) -> Iterator[LexiconRule]:
        yield from cls.escapes()
        yield r'\n', skip, -1
    ...
    @lexicon
    def name(cls) -> Iterator[LexiconRule]:
    ...
    @lexicon
    def preprocess_lilypond(cls) -> Iterator[LexiconRule]:
    ...
    @lexicon(re_flags=re.MULTILINE)
    def lilypond(cls) -> Iterator[LexiconRule]:
    ...
    @classmethod
    def escapes(cls, escape_base: StandardAction = Text) -> Iterator[LexiconRule]:
        # escapes (man 7 groff)
